...
document.addEventListener("DOMContentLoaded", () => {
  ...
  form.addEventListener("submit", async (e) => {
    ...
    try {
      ...
      // Show the technical reason (e.g. "permission-denied") right on the
      // page, in small print — so if this keeps failing, a screenshot of
      // the page itself is enough to diagnose it, no DevTools needed.
      const code = err && err.code ? " (" + err.code + ")" : "";
      showMsg("error", veloraT("booking.errorMsg") + code);
    } finally {
