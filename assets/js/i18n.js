...
const VELORA_I18N = {
  en: {
    ...
    "booking.phSessionType": "Select a type (optional)",
    "booking.optPortrait": "Artistic Portraits",
    "booking.optStreet": "Street Photography",
    "booking.optOther": "Not sure yet",
    "booking.labelPreferredDate": "Preferred Date (optional)",
    "booking.labelMessage": "Message (optional)",
  ...
  ar: {
    ...
    "footer.founder": "تأسست على يد روان ديسا السيد",
    ...
    "home.introText": "فيلورا هي بيت إعلامي مصري أسسته روان ديسا السيد، نقدم خدمات تصوير فوتوغرافي محترفة وخدمات فريلانس أونلاين، وننطلق من رؤية فنية وأخلاقية مميزة — لقطات نابعة من الروح، بطابع عصري وجريء.",
    ...
    "about.heroSubtitle": "تأسست على يد روان ديسا السيد",
    "about.visionEyebrow": "رؤيتنا",
    "about.visionTitle": "روح فنية صادقة",
    "about.visionP1": "فيلورا هي بيت إعلامي مصري أسسته روان ديسا السيد. نقدم خدمات تصوير فوتوغرافي محترفة وخدمات فريلانس أونلاين، منطلقين من رؤية فنية وأخلاقية فريدة.",
    ...
    "booking.phSessionType": "اختاري نوعًا (اختياري)",
    "booking.optPortrait": "بورتريه فني",
    "booking.optStreet": "تصوير الشارع",
    "booking.optOther": "لم أقرر بعد",
    "booking.labelPreferredDate": "التاريخ المفضل (اختياري)",
    "booking.labelMessage": "رسالة (اختياري)",
